...
Route::get('/spanduks/trash','SpandukController@trash')->name('spanduks.trash');
Route::post('/spanduks/{id}/restore','SpandukController@restore')->name('spanduks.restore');
Route::delete('/spanduks/{id}/delete-permanent','SpandukController@deletePermanent')->name('spanduks.delete-permanent');
Route::resource('spanduks', 'SpandukController');
...
Route::delete('/remove-from-cart','CartController@removeCart')->name('cart.remove');
