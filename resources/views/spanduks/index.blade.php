...
@section('title') Spanduk list @endsection
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a 
								href="{{route('spanduks.edit', ['id' => $spanduk->id])}}"
								class="btn btn-info btn-sm">Edit</a>
							<a 
								href="{{route('spanduks.show', ['id' => $spanduk->id])}}"
							...
							<form
								...
								class="d-inline"
								method="POST"
								action="{{route('spanduks.destroy', ['id' => $spanduk->id])}}">
								@csrf
