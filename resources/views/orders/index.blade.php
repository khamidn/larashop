		...
		<div class="row">
			...
			<div class="col-md-2">
				<select name="status" class="form-control" id="status">
					...
					<option {{Request::get('status' == "SUBMIT" ? "selected" : "")}}>SUBMIT</option>
					<option {{Request::get('status' == "PROCESS" ? "selected" : "")}}>PROCESS</option>
					<option {{Request::get('status' == "FINISH" ? "selected" : "")}}>FINISH</option>
					<option {{Request::get('status' == "CANCEL" ? "selected" : "")}}>CANCEL</option>
				</select>
			</div>
			<div class="col-md-2">
