...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('categories.create')->with('status','Catefory successfuly created');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('categories.edit', ['id' => $id])->with('status', 'Edit category successfully');
    }
    ...
    public function deletePermanent($id){
        ...
        if(!$category->trashed()){
            return redirect()->route('categories.index')->with('status', 'Can not delete permanet active category');
        }
